...
const primaryColor = "oklch(0.72 0.16 135)"; // #22c55e
const backgroundColor = "oklch(1 0 0)"; // #ffffff
const foregroundColor = "oklch(0.2 0.02 240)"; // #1f2937
...
export const sendOtpEmail = async (to: string, otp: string) => {
  ...
  await transporter.sendMail({
    ...
    to,
    subject: "ProFlow - Secure OTP Verification",
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="description">
        To access your ProFlow account, please use the following one-time password.
      </p>
